...
const Button = ({ children, primary = true, onClick, className = '' }: ButtonProps) => (
  <button
    onClick={onClick}
    className={`
      px-6 py-3 rounded-md text-sm font-semibold transition-all duration-300 ease-in-out
      ${primary
        ? `bg-[${colors.accentPrimary}] text-[${colors.primaryText}] hover:bg-[${colors.accentAlternative}]`
        : `bg-transparent border border-[${colors.accentPrimary}] text-[${colors.accentPrimary}] hover:bg-[${colors.accentPrimary}] hover:text-[${colors.primaryText}]`}
      ${className}
    `}
  >
    {children}
...
// Card Component for Featured/Latest
...
const MainContent = () => {
  ...
  return (
    ...
    <div className={`py-12 md:py-20 bg-[${colors.mainBackground}]`}>
      <div className="container mx-auto px-4">
        {/* Featured Resources Section */}
        <h2 className={`text-3xl md:text-4xl font-extrabold text-center mb-12 text-[${colors.primaryText}]`}>
          Featured Resources
        </h2>
        ...
        <div className={`text-center py-16 px-6 rounded-lg bg-secondary shadow-lg`}>
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Button>
              <Search className="inline-block mr-2 text-white" size={18} />
              Explore All Resources
            </Button>
            <Button primary={false}>
              <Upload className="inline-block mr-2 text-white" size={18} />
  ...
  return (
    ...
    <section className="header_img bg-cover bg-center min-h-[70vh] flex items-center">
      <div className="px-4 mx-auto max-w-7xl text-center py-20">
        ...
        <p className="text-lg md:text-xl lg:text-2xl primary-text mb-8">Discover, Share, and Collaborate on Valuable Resources</p>
        <div className="flex justify-center gap-4">
          <button className="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg text-lg md:text-xl lg:text-2xl duration-500 cursor-pointer">Get Started</button>
          <button className="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg text-lg md:text-xl lg:text-2xl duration-500 cursor-pointer">Learn More</button>
        </div>
      </div>
    </section>
    ...
    <section className="grids_section w-full mx-auto px-4 my-16">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 items-start">
        <article className="w-full bg-secondary col-span-1 text-center p-6 border border-gray-300 rounded-lg shadow-lg">
          <h2 className="text-3xl font-extrabold primary-text">20+</h2>
          <p className="mt-2 primary-text font-normal ">Documents uploaded by students.</p>
        </article>
        <article className="w-full bg-secondary col-span-1 text-center p-6 border border-gray-300 rounded-lg shadow-lg">
          <h2 className="text-3xl font-extrabold primary-text">300+</h2>
          <p className="mt-2 primary-text font-normal ">Students using the website.</p>
        </article>
        <article className="w-full bg-secondary col-span-1 text-center p-6 border border-gray-300 rounded-lg shadow-lg">
          <h2 className="text-3xl font-extrabold primary-text">4+</h2>
          <p className="mt-2 primary-text font-normal ">Partnered with companies.</p>
        </article>
        <article className="w-full bg-secondary col-span-1 text-center p-6 border border-gray-300 rounded-lg shadow-lg">
          <h2 className="text-3xl font-extrabold primary-text">12x</h2>
          <p className="mt-2 primary-text font-normal ">Of knowledge gained by students.</p>
        </article>
      </div>
    ...
    <section className="study bg-secondary mb-10">
      <div className="px-4 mx-auto max-w-7xl text-center py-20">
        ...
        <p className="text-lg md:text-xl lg:text-2xl primary-text mb-8">Join a community of learners and access a wealth of resources to support your academic journey.</p>
        <div className="flex justify-center gap-4">
          <button className="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg text-lg md:text-xl lg:text-2xl duration-500 cursor-pointer">Join Now</button>
          <button className="bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-lg text-lg md:text-xl lg:text-2xl duration-500 cursor-pointer">Explore Resources</button>
        </div>
      </div>
    </section>
